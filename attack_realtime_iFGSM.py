...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for epoch in range(3):
            ...
            # 图像混合
            # alpha = 0.2
            # perturbed_image = alpha * torch.tensor(im, dtype=torch.float32) + (1 - alpha) * perturbation
        ...
        for i, det in enumerate(pred):  # per image
            ...
            perturbation_output = np.transpose(perturbation.cpu().detach().numpy(), (0, 2, 3, 1))[0]*255
