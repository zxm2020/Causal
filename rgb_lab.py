...
if __name__ == '__main__':
    img = cv2.imread(r'/home/zhengshujie/zxm_code/yolov5-master/data/images/bus.jpg')
    print(img.shape)
    img = np.ones((1080, 810, 3))
    w = img.shape[0]
    h = img.shape[1]
    ...
    cv2.imwrite(r'/home/zhengshujie/zxm_code/yolov5-master/data/images/test.jpg', img_new)
